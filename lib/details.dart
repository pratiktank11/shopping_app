              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    height: 30,
                    width: 40,
                    child: Center(child: Text(snapshot.data![widget.indexOfProduct]['Discount'].toString())),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: ImageScreen(snapshot.data[widget.indexOfProduct]['Img']['im1'],snapshot.data[widget.indexOfProduct]['Img']['im2'],snapshot.data[widget.indexOfProduct]['Img']['im3'],snapshot.data[widget.indexOfProduct]['Img']['im4']),
                    ),
                    decoration: BoxDecoration(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text(snapshot.data[widget.indexOfProduct]["Price"],style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 25
                                  )),
                                ),
